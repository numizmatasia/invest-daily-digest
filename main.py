...
7. Если новость может повлиять на конкретный актив моего портфеля, обязательно назови этот актив.
8. Если влияние слабое или отсутствует — прямо так и напиши.
9. Не пересказывай новости. Объясняй последствия для инвестора.
Формат ответа:
📌 Главное за сутки
(максимум 5 пунктов)
...
- направление влияния (позитивно / нейтрально / негативно)
- силу влияния (слабое / среднее / сильное)
- изменился ли инвестиционный тезис

Не пересказывай новости.
Объясняй последствия для инвестора.
